...
public final class FlowerConstants {
	...
	// Spring color scheme
	public static final float[] SCHEME_SPRING_BG_BOTTOM = { 1f, 1f, .5f, 1f };
	public static final float[] SCHEME_SPRING_BG_TOP = { .8f, .8f, .5f, 1f };
	...
	public static final float[] SCHEME_SUMMER_PLANT_1 = { .8f, .6f, .6f, .8f };
	public static final float[] SCHEME_SUMMER_PLANT_2 = { .6f, .8f, .6f, .8f };
	// Winter color scheme
	public static final float[] SCHEME_WINTER_BG_BOTTOM = { .9f, .9f, .9f, 1f };
	public static final float[] SCHEME_WINTER_BG_TOP = { .8f, .8f, .8f, 1f };
